const feedObj = {
    ...
    makeFeedItem: function(item) {
        ...
        const writerImg = `<img src='/static/img/profile/${item.iuser}/${item.mainimg}' 
            onerror='this.error=null;this.src="/static/img/profile/profile.png"'>`;
    ...
    // const btnChangePP = querySelector('#btnChangePP');
    // btnChangePP.innerText = 'Change Profile pic';
    // btnChangePP.addEventListener('click', function() {
    //     const uploadPP = document.createElement('button');
    //     uploadPP.type = 'button';
    //     uploadPP.className = 'btn';
    //     uploadPP.innerText = 'Choose from library';
